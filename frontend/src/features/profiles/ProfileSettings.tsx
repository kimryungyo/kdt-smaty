...
const emptyDraft = (): Draft => ({
  ...
  ledBrightness: "", tiltLevel: "", description: "",
});
...
function toInput(draft: Draft): ProfileInput | ActivityModeInput | null {
  ...
  return {
    ...
    ledBrightness, tiltLevel, description: draft.description.trim() || null,
  };
}
